...
const EVENTS_ANCHOR = `${HOME_PATH}#events-preview`;
...
function HomeEventsPreview() {
  return (
    <section id="events-preview" className="bg-white px-5 py-14 md:px-12 md:py-[90px]">
      <div className="mx-auto max-w-7xl">
        <div className="mb-10 flex flex-col items-start justify-between gap-4 md:flex-row md:items-end">
          ...
          <a href={EVENTS_ANCHOR} className="border-b-2 border-brand-yellow pb-1 text-base font-bold whitespace-nowrap text-brand-near-black">
            All events →
          </a>
        </div>
          ...
          <article className="overflow-hidden rounded-[18px] border border-brand-border-warm bg-brand-near-black transition hover:-translate-y-1 hover:shadow-[0_20px_44px_rgba(0,0,0,0.16)]">
            ...
            <div className="px-7 py-6">
              ...
              <p className="mt-2.5 text-[15px] leading-relaxed text-[#b9b9b9]">
                Chalk up every week with the North-side crew. Top rope, bouldering, then trà sữa on the way home. Never climbed? Doesn&apos;t matter, and you
                can hire shoes there.
              </p>
              <div className="mt-4 flex flex-wrap items-center gap-4 text-[13.5px] text-brand-gray">
                <span className="inline-flex items-center gap-1.5">
